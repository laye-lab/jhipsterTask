...
import com.seneau.task.domain.Task;
import com.seneau.task.repository.TaskRepository;
...
public class TaskResourceIT {
    ...
    private static final String DEFAULT_COMPLETED = "AAAAAAAAAA";
    private static final String UPDATED_COMPLETED = "BBBBBBBBBB";
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getDuedate()).isEqualTo(DEFAULT_DUEDATE);
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getDuedate()).isEqualTo(UPDATED_DUEDATE);
